...
def chatbot():
    ...
    with col2:
        openai_api_key = "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"
...
•	Tipo de Fondo
Fondo de Deuda.
Te permitirá proteger tu capital y conocer tu  rendimiento desde el inicio de la inversión,  cuenta con una permanencia mínima de 91 días,  así como una inversión mínima de $50 mil pesos.
•	Riesgo
Extremadamente bajo.
•	Perfil de Inversionista
Dirigido a inversionistas que buscan obtener un  premio adicional por su permanencia.
Ideal para el perfil de Preservación de Capital  que mantiene estable su capital sin correr  riesgos.
•	Estrategia
Es un fondo 100% de deuda con un horizonte  de inversión a corto plazo compuesto por  valores gubernamentales, bancarios y/o  corporativos con la mejor calidad crediticia  (AAA) y un rendimiento objetivo del 100%. CETES a 91 días.


Rendimientos brutos anualizados (antes de la retención de impuestos correspondientes y comisiones).  Los rendimientos pasados no garantizan rendimientos futuros.
Fuente Cetes 91 días: www.banxico.org.mx .

•	Composición de Cartera
-	BONOS DE DESARROLLO DEL  GOBIERNO FEDERAL 99.68%
-	BONOS DE PROTECCIÓN AL  AHORRO 0.32%

•	El NTEPZO nos brinda
o	Un horizonte de inversión: corto plazo.
o	Plazo mínimo recomendado: 91 días.
o	Calificación: AAA/1
o	Perfil de inversionista: Todos los perfiles.
o	Horario de operación: 8:00 a 13:00 horas
o	Disponibilidad: mismo día.
o	Inversión mínima: $50,000 mnx.
o	Segmento: personal y preferente. 

Fondo Banorte dólares (NTEDLS)
•	Tipo de Fondo
-	Fondo de Cobertura
-	Te permitirá respaldar el valor de tu  dinero ante las fluctuaciones del tipo de  cambio peso-dólar.
•	Riesgo
-	Bajo.	
•	Perfil de Inversionista
-	Dirigido a inversionistas que buscan  estabilidad y un mejor resguardo del valor  del peso respecto al dólar (USD).
-	Ideal para el perfil de Preservación de  Capital que mantiene estable su capital sin  correr riesgos.
•	Estrategia
•	Es un fondo conformado principalmente por  activos de deuda con la mejor calidad  crediticia (AAA) denominados, indizados y/o  referenciados al dólar.
Conoce sus rendimientos históricos
Conoce sus rendimientos históricos
a)	Serie física NTEDLS F5, con rango de inversión de $50 – $299,999, con comisión del 1.75%, el último mes del 0.02%, en el año un -7.10% y por 12 meses un -10.92%

b)	Serie física NTEDLS F4, con rango de inversión de $300,000 – $999,999, con comisión del 1.50%, el último mes del 0.04%, en el año un -7.01% y por 12 meses un -10.66%.

c)	Serie física NTEDLS F3, con rango de inversión de $1,000,000 – $9,999,999, con comisión del 1.25%, el último mes del 0.07%, en el año un -6.92% y por 12 meses un -10.40%.

d)	Serie física NTEDLS F2, con rango de inversión de $10,000,000 – $49,999,999, con comisión del 1.00%, el último mes del 0.9%en el año un -6.83% y por 12 meses un -10.14%.

e)	Serie física NTEDLS F1, con rango de inversión de $50,000,000 en delante, con comisión del 0.75%, el último mes del 0.11%, en el año un -6.74% y por 12 meses un -9.88%.

Rendimientos netos anualizados (después de la retención de impuestos correspondientes y comisiones).
Los rendimientos pasados no garantizan rendimientos futuros.
Series Accionarias: F1, F2, F3, F4, F5 (Personas Físicas), Comisión por administración conforme al rango de inversión.

•	Composición de Cartera
-	LIQUIDEZ 100%
-	
•	El NTEDLS nos brinda:
o	Un horizonte de inversión: corto plazo.
o	Plazo mínimo recomendado: 1 año o más.
o	Calificación: AAA/5
o	Perfil de inversionista: Todos los perfiles.
o	Horario de operación: 8:00 a 13:30 horas
o	Disponibilidad: 48 horas.
o	Inversión mínima: $50 mnx.
o	Segmento: preferente. 

Fondo Banorte Dólares + (NTEDLS+)
•	Tipo de Fondo
-	Fondo de Renta Variable en  Dólares.
-	Te permitirá acceder a una estrategia de  cobertura cambiaria (peso – dólar) con un  rendimiento adicional.
•	Riesgo
-	Moderado
•	Perfil de Inversionista
-	Dirigido a inversionistas que buscan una inversión internacional.
-	Ideal para el perfil Conservador que busca  hacer crecer su capital de manera estable,  con cierto riesgo y volatilidad acotada. Acepta  desviaciones temporales en rendimientos y  una minusvalía en el capital de forma  limitada.
•	Estrategia
•	Es un fondo conformado principalmente por activos denominados en dólares.
Conoce sus rendimientos históricos
a)	Serie física NTEDLS+ F5, con rango de inversión de $50 – $299,999, con comisión del 1.75%, el último mes del 0.21%, en el año un -6.22% y por 12 meses un -12.15%

b)	Serie física NTEDLS+ F4, con rango de inversión de $300,000 – $999,999, con comisión del 1.50%, el último mes del 0.23%, en el año un -6.13% y por 12 meses un -11.90%.

c)	Serie física NTEDLS+ F3, con rango de inversión de $1,000,000 – $9,999,999, con comisión del 1.25%, el último mes del 0.25%, en el año un -6.04% y por 12 meses un -11.64%.

d)	Serie física NTEDLS+ F2, con rango de inversión de $10,000,000 – $49,999,999, con comisión del 1.00%, el último mes del 0.28%en el año un -5.95% y por 12 meses un -11.39%.

e)	Serie física NTEDLS+ F1, con rango de inversión de $50,000,000 en delante, con comisión del 0.75%, el último mes del 0.30%, en el año un -5.87% y por 12 meses un -11.13%.
...
•	Composición de Cartera
-	Vanguard Dólares Bono Corporativo 1-3 Años UCITS ETF  13.93%
-	Vanguard Bonos Gubernamentales de Mercados Emergentes  ETF 10.01%
-	Vanguard Fondo de Bonos Corporativos UCITS Dólares 25.95%
-	Vanguard U.S. Bonos Tesoro Acumulado 0-1 Año UCITS ETF  (USD) 41.90%
-	Vanguard Valores Respaldados por Hipotecas ETF 6.98%
-	Vanguard Acciones Mundiales ETF 1.13%  
-	Liquidez 0.10%
-	
•	El NTEDLS nos brinda:
-	Un horizonte de inversión: largo plazo.
-	Plazo mínimo recomendado: 2 año o más.
-	Calificación: N/A
-	Perfil de inversionista: Moderado.
-	Horario de operación: 8:00 a 13:30 horas
-	Disponibilidad: 48 horas.
-	Inversión mínima: $50 mnx.
-	Segmento: preferente. 

Fondo Estrategia NTED
•	Tipo de Fondo
-	Fondo de Deuda.
-	Cuenta con una estrategia relativamente  conservadora de selección de activos que te  permite preservar y mejorar tu patrimonio.
•	Riesgo
-	Moderado.
•	Perfil de Inversionista
-	Dirigido a inversionistas que buscan un rendimiento superior a la deuda gubernamental.
-	Ideal para el perfil Conservador que busca hacer  crecer su capital de manera estable, con cierto  riesgo y volatilidad acotada. Acepta desviaciones  temporales en rendimientos y una minusvalía en el  capital de forma limitada.
•	Estrategia
-	Es un fondo 100% de deuda con un horizonte de  inversión a mediano plazo compuesto por Fondos  de deuda gubernamental nacional, internacional  y corporativa, todos administrados por la  Operadora de Fondos Banorte.
-	
Conoce sus rendimientos históricos
a)	Serie física NTED F5, con rango de inversión de $50 – $999,999, con comisión del 1.80%, el último mes del 7.87%, en el año un 7.69% y por 12 meses un 6.66%

b)	Serie física NTED F4, con rango de inversión de $1,000,000 – $4,999,999, con comisión del 1.53%, el último mes del 8.24%, en el año un 8.07% y por 12 meses un 7.06%.

c)	Serie física NTED F3, con rango de inversión de $5,000,000 – $9,999,999, con comisión del 1.25%, el último mes del 8.57%, en el año un 8.40% y por 12 meses un 7.41%.

d)	Serie física NTED F2, con rango de inversión de $10,000,000 – $49,999,999, con comisión del 1.00%, el último mes del 8.86%, en el año un 8.70% y por 12 meses un 7.73%.

e)	Serie física NTED F1, con rango de inversión de $50,000,000 en delante, con comisión del 0.75%, el último mes del 9.15%, en el año un 9.00% y por 12 meses un 8.04%.
Rendimientos netos anualizados (después de la retención de impuestos correspondientes y comisiones).
Los rendimientos pasados no garantizan rendimientos futuros.
Series Accionarias: F1, F2, F3, F4, F5 (Personas Físicas), Comisión por administración conforme al rango de inversión
•	Composición de Cartera
-	Deuda Corporativa 42.98%
-	Bonos M.P. 21.70%
-	Corto Plazo. 19.56%
-	Bonos L.P. 8.78%
-	Mediano Plazo.6.98%
...
•	El NTED nos brinda:
-	Un horizonte de inversión: mediano plazo.
-	Plazo mínimo recomendado: 1 a 3 años.
-	Calificación: AAA/4
